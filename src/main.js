const songList = [
  {
    ...
    file: "AviciiTheNights.mp3",
    cover: "src/img/avicii.jpg"
  },
  {
    title: "Babasónicos Y que",
    file: "BabasónicosYQue.mp3",
    cover: "src/img/babasonicos.jpg"
  },
  {
    title: "Nirvana Smells Like Teen Spirit",
    file: "NirvanaSmellsLikeTeenSpirit.mp3",
    cover: "src/img/nirvana.jpg"
  },
  {
    title: "Aerosmith Jaded",
    file: "AerosmithJaded.mp3",
    cover: "src/img/aerosmith.jpg"
  }
];
...
function changeCover(songIndex) {
  cover.src = "src/img/" + songList[songIndex].cover;
}
